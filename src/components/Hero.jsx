...
const Hero = () => {
  return (
    <div className="bg-cyan-500 text-white py-24 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mt-8 p-8 bg-green-900 bg-opacity-40 rounded-3xl shadow-2xl max-w-lg mx-auto transition-all duration-300 ease-in-out">
