    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-black via-indigo-900 to-black text-white">
      <div className="container mx-auto px-6 py-12 flex flex-col min-h-screen shadow-xl rounded-lg bg-opacity-90 backdrop-blur-md">
        ...
        <header className="w-full py-6 px-8 bg-gradient-to-r from-gray-900 via-indigo-800 to-gray-900 shadow-2xl rounded-lg sticky top-0 z-10 flex justify-between items-center transform transition-all hover:scale-105">
          <h1 className="text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-600 drop-shadow-lg">
            Top Tests
          </h1>
          <nav className="flex space-x-6">
            <button
              className="px-6 py-3 bg-blue-600 text-white rounded-lg shadow-lg hover:bg-blue-700 transition-all transform hover:scale-110 hover:shadow-2xl"
              onClick={() => navigate("/Signup")}
            >
              Ro‘yxatdan o‘tish
            </button>
            <button
              className="px-6 py-3 bg-gray-600 text-white rounded-lg shadow-lg hover:bg-gray-700 transition-all transform hover:scale-110 hover:shadow-2xl"
        ...
        <main className="flex-grow flex flex-col items-center justify-center text-center px-6 py-16">
          <h2 className="text-5xl font-bold leading-tight bg-gradient-to-r from-blue-300 to-purple-500 text-transparent bg-clip-text drop-shadow-lg mt-6">
            Top Tests saytiga Xush Kelibsiz
          </h2>
          <p className="text-xl max-w-2xl mt-4 text-gray-300">
            <span className="font-bold text-white">200,000+</span> testlar bilan
            barcha fanlardan bilimlaringizni sinang!
          </p>
          <p className="text-lg max-w-3xl mt-4 text-gray-400">
